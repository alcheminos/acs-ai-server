// Setup: Deno 기반 Supabase Edge Function
import { serve } from "https://deno.land/std@0.168.0/http/server.ts";

// Supabase 대시보드에서 설정한 GEMINI_API_KEY를 가져옵니다.
...
serve(async (req) => {
  ...
  try {
    ...
    // Google Gemini API 호출 (Gemini 1.5 Flash 사용)
